...
class SuggestedQuestionsEvent(BaseModel):
    """Suggested questions generated by Gemini after ingestion completes.

    Sent once per ingestion job so the frontend can surface clickable
    question chips in the VoicePanel.
    """

    type: ServerEventType = ServerEventType.SUGGESTED_QUESTIONS
